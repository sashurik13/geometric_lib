...
from fyles.circle import area, perimeter
...
class CircleTestCase(unittest.TestCase):
    ...
    def test_area_big_numbers(self): # проверка на очень большие числа
        ...
        self.assertAlmostEqual(area(2500000000), math.pi * 25000000000 ** 2, places=0)
    ...
    #периметр
    #далее функции такие же только для периметра 
    def test_perimeter_positive_integer(self):
        self.assertEqual(perimeter(4), 2 * math.pi * 4)
        self.assertEqual(perimeter(9), 2 * math.pi * 9)
        self.assertEqual(perimeter(15), 2 * math.pi * 15)

    def test_perimeter_positive_float(self):
        self.assertAlmostEqual(perimeter(3.5), 2 * math.pi * 3.5, places=7)
        self.assertAlmostEqual(perimeter(2.8), 2 * math.pi * 2.8, places=7)
        self.assertAlmostEqual(perimeter(6.75), 2 * math.pi * 6.75, places=7)
    ...
    def test_perimeter_large_numbers(self):
        self.assertEqual(perimeter(10000000000), 2 * math.pi * 10000000000)
        self.assertEqual(perimeter(98789676), 2 * math.pi * 98789676)
